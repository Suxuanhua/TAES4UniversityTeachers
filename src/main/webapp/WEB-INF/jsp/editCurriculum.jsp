...
<div class="reg_page">
    ...
    <form name="Register_form" method="post"
          action="${pageContext.request.contextPath }/curriculum/editcurriculumsubmit.su">
        <input name="curriculumID" type="hidden" value="${curriculum.curriculumID }"/>
        <div class="reg_content">
            <ul>
                <li><input name="curriculumName" type="text" placeholder="课程名称" value="${curriculum.curriculumName }"/>
                </li>
                <li><input name="classHours" type="text" placeholder="课程课时" value="${curriculum.classHours }"/>
                </li>
                <li><input name="grade" type="text" placeholder="课程授课年级" value="${curriculum.grade }"/></li>
                <li><input name="className" type="text" placeholder="课程授课班级" value="${curriculum.className }"/>
                </li>
                <li><input name="teachingNumber" type="text" placeholder="课程授课人数"
                           value="${curriculum.teachingNumber }"/></li>
                <%--直接通过老师条目修改课程，该处可省--%>
                <li>
                    <input name="teacherID" type="text" placeholder="课程教师ID" value="${curriculum.teacherID }"/>
                </li>
                <%--直接通过老师条目修改课程，该处可省--%>
                <li><input name="teacherName" type="text" placeholder="课程教师姓名"
                ...
                <li class="radio_ctrl">
                    ...
                    <input name="teacherSex" class="radio_ctrl_in" type="radio" value="0" <c:if
                            test="${curriculum.teacherSex eq '0' }"> checked </c:if> />女
                </li>
                <%--直接通过老师条目修改课程，该处可省--%>
                <li style="margin-top: 10px;">
                    <input name="teacherPhoneNumber" type="tel" placeholder="课程教师手机号"
                           value="${curriculum.teacherPhoneNumber }"
                           required pattern="^(0|86|17951)?(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}">
                </li>
                <%--直接通过老师条目修改课程，该处可省--%>
                <li><input name="teacherEMail" type="email" spellcheck="false" placeholder="课程教师邮箱"
                           value="${curriculum.teacherEMail }"></li>
                <li><input name="curriculumNote" type="text" placeholder="课程备注" value="${curriculum.curriculumNote }">
                </li>
