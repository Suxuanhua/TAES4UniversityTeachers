...
<div class="reg_page">
    ...
    <form name="Register_form" method="post" enctype="multipart/form-data"
          action="${pageContext.request.contextPath }/teacher/addteacher.su">
        <div class="reg_content">
            <ul>
                <li><input name="teacherName" type="text" placeholder="新教师的姓名" value="${teacher.teacherName }"/></li>
                <li><input name="teacherTitle" type="text" placeholder="新教师的职称" value="${teacher.teacherTitle }"/></li>
                ...
                <li><input name="teacherPhoneNumber" type="tel" placeholder="需要绑定的手机号码"
                           value="${teacher.teacherPhoneNumber }"
                           required pattern="^(0|86|17951)?(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}">
                </li>
                <li><input name="teacherEMail" type="email" spellcheck="false" placeholder="需要绑定的邮箱"
                           value="${teacher.teacherEMail }"></li>
                <li><input name="teacherNote" type="text" placeholder="新教师备注" value="${teacher.teacherNote }"></li>
                <li>
